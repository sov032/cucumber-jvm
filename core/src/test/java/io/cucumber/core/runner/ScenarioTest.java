...
public class ScenarioTest {
    ...
    public void provides_the_scenario_line() {
        List<Location> scenarioLocation = asList(new Location(line(3), column(2)));
    ...
    public void provides_both_the_example_row_line_and_scenario_outline_line_for_scenarios_from_scenario_outlines() {
        List<Location> scenarioLocation = asList(new Location(line(8), column(4)), new Location(line(3), column(2)));
        Scenario scenario = createScenarioWithScenarioLocations(scenarioLocation);
    ...
    private Scenario createScenarioWithFeatureFileUri(String uri) {
        return createScenarioWithFeatureFileUriAndScenarioLocations(uri, asList(new Location(1, 1)));
    }

    private Scenario createScenarioWithScenarioLocations(List<Location> locations) {
        return createScenarioWithFeatureFileUriAndScenarioLocations("uri", locations);
    }

    private Scenario createScenarioWithFeatureFileUriAndScenarioLocations(String uri, List<Location> locations) {
